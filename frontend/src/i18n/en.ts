export default {
  ...
  recommendation: {
    ...
    unmatchedCriteria: 'Unmatched criteria',
  ...
  help: {
    title: 'Help & Support',
    subtitle: 'Quick answers to common questions about using Saksham.',
    faqTitle: 'Frequently asked questions',
    q1: 'Do I need to login to check eligibility?',
    q1a: 'No. The public eligibility flow works without any login.',
    q2: 'Are these figures official?',
    q2a: 'Saksham shows sourced scheme information and links every scheme to its official source. Always verify figures against the latest official guidelines before applying.',
    q3: 'What makes a recommendation?',
    q3a: 'A deterministic rule engine scores purpose, income, project size and loan limits, then explains the match in plain language.',
    contactTitle: 'Still need help?',
    contactDesc: 'Email us and we will get back to you.',
  },
  footer: {
    about: 'About',
    how: 'How it works',
